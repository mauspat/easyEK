...
public class SupermarketPanel extends JPanel{
	...
	private void addCreateSupermarketPanel() {
		...
		createButton.setToolTipText("Beim anlegen wird ein Fenster aufgerufen, in dem du die Reihenfolge der Kategorien bestimmen kannst.");
		createButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					//exc.printStackTrace();
					JOptionPane.showMessageDialog(UI.getMainPanel(), "Postleitzahl kann nur aus Ziffern bestehen!", "Fehler", JOptionPane.ERROR_MESSAGE);
					return;
				}
				...
				int a = JOptionPane.showConfirmDialog(UI.getMainPanel(), sortCatButtons, "Sortierung des Supermarktes", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE,null);
				...
				JOptionPane.showMessageDialog(UI.getMainPanel(), "Supermarkt wurde erstellt", "Supermarkt erstellt", JOptionPane.INFORMATION_MESSAGE);
	...
	private void addOverviewList() {
		...
		delButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				int a = JOptionPane.showConfirmDialog(upperPanel, "Sollen die ausgewählten Märkte wirklich gelöscht werden?", "Löschen", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
				if(a==0) {
					Supermarket.deleteSupermarket(overviewList.getSelectedValuesList());
					dlm.clear();
					dlm.addAll(Supermarket.getSupermarketList());
					JOptionPane.showMessageDialog(upperPanel, "Die Supermärkte wurden gelöscht!", "Elemente gelöscht", JOptionPane.INFORMATION_MESSAGE);
